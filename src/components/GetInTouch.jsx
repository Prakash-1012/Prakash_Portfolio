        ...
        <div id="GetInTouch" data-aos="fade-right" className='w-screen h-full mb-10'>
            ...
            <div className='lg:grid grid-cols-2  lg:ml-20 mt-5 p-5'>
                <div>
                    ...
                    <div className='border-[1px] border-gray-700 dark:bg-gray-800 max-lg:w-110 lg:w-120 pl-4 flex flex-col justify-center h-20 rounded-xl dark:hover:bg-gray-700 mb-5'>
                    ...
                    <div className='mt-5 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 animate-gradient max-lg:w-110  lg:w-130 lg:h-30 max-lg:mb-5 p-5 rounded-lg'>
                ...
                <div className='rounded-lg border-gray-700 shadow-gray-800 shadow-sm border-[.5px] max-lg:pl-5 lg:pl-10 pt-5 max-lg:w-110  lg:w-140 max-lg:h-160 lg:h-150 dark:bg-gray-800'>
                    <div>
                    ...
                    <form action="" ref={form} onSubmit={handleMessage}>
                        ...
                        <button type='submit' className='lg:w-[453px] mb-5 flex justify-center items-center text-xl text-white font-semibold bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 h-15 rounded-lg hover:opacity-80 animate-gradient max-lg:w-95'>
                            Send Message
                        </button>
                    </form>
