    ...
    return (
        <div id="AboutMe" data-aos="fade-right" className='mt-35 mb-5  w-screen h-full'>
            <div className='justify-center flex w-screen '>
                <div className=' max-sm:text-lg bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent lg:text-6xl mt-5 animate-gradient font-semibold'>
                    <h2>About Me</h2>
