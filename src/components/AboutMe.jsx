    ...
    return (
        <div data-aos="fade-right" className='mt-35  w-screen h-full'>
            ...
            <div className='p-5 lg:grid grid-cols-2 gap-12  m-10 lg:h-150 lg:w-full '>
                <div>
                    <h1 className='font-bold max-lg:text-lg lg:text-4xl text-white ml-5 '>Passionate Frontend Developer</h1>
                ...
                <div className='outline-2 outline-gray-600 md:w-120 lg:h-70 box-border shadow-indigo-500 rounded-2xl p-5'>
